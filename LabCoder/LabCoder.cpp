...
// LabCoder.cpp: Definiert das Klassenverhalten für die Anwendung.
//
...
BEGIN_MESSAGE_MAP(CLabCoderApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// CLabCoderApp-Erstellung

CLabCoderApp::CLabCoderApp()
{
...
// Das einzige CLabCoderApp-Objekt

CLabCoderApp theApp;


// CLabCoderApp-Initialisierung

BOOL CLabCoderApp::InitInstance()
{
