================================================================================
    MICROSOFT FOUNDATION CLASS-BIBLIOTHEK: LabCoder-Projektübersicht
===============================================================================

Diese LabCoder-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt. Diese Anwendung zeigt nicht nur die Grundlagen der Verwendung von Microsoft Foundation Classes, sondern dient auch als Ausgangspunkt für das Schreiben Ihrer Anwendung.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre LabCoder-Anwendung besteht.
...
LabCoder.h
    ...
    Sie enthält andere projektspezifische Header (einschließlich Resource.h) und deklariert die CLabCoderApp-Anwendungsklasse.

LabCoder.cpp
    Dies ist die wichtigste Anwendungsquelldatei, die die Anwendungsklasse CLabCoderApp enthält.
...
res\LabCoder.ico
    Dies ist eine Symboldatei, die als Anwendungssymbol verwendet wird. Dieses Symbol ist in der Hauptressourcendatei LabCoder.rc enthalten.
...
LabCoderDlg.h, LabCoderDlg.cpp - das Dialogfeld
    Diese Dateien enthalten Ihre CLabCoderDlg-Klasse. Diese Klasse definiert das Verhalten des Hauptdialogfelds der Anwendung. Die Vorlage für das Dialogfeld befindet sich in LabCoder.rc und kann in Microsoft Visual C++ bearbeitet werden.
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen LabCoder.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
